...
public class ChatFormatConstant {
    ...
    public static String SETTING_DATAFORMAT, SETTING_PREFIX;
    ...
    public static String CHARACTER_MESSAGE;

    public static boolean CALL_ENABLE;
    public static String CALL_KET, CALL_SOUND;

    public static boolean BLACK_TERMS_ENABLE, BLACK_TERMS_FOR_EVERY_BODY, BLACK_CANCEL;
    public static String BLACK_TERMS_SCRIPT;
    public static List<String> BLACK_TERMS_TERMS;

    public static String MESSAGE_RELOAD, MESSAGE_MISSING_PERMISSION, MESSAGE_MUTE_WRONG, MESSAGE_MUTE_SUCCESS, MESSAGE_NOT_FOUND_PLAYER;
