...
public class ResolveLagConstant {
    ...
    public static String RESOLVE_LAG_SECOND_TIME;
    ...
    public static long RESOLVE_LAG_ENTITY_TOTAL_LIMIT;
    public static List<String> RESOLVE_LAG_ENTITY_SPECIAL_ITEM,
            RESOLVE_LAG_ENTITY_SPECIAL_ENTITY;

    public static long RESOLVE_LAG_CHUNK_INTERVAL, RESOLVE_LAG_TOTAL_LIMIT;
    public static boolean RESOLVE_LAG_TOTAL_ENABLE;

    public static List<String> RESOLVE_LAG_WHITE_WORLD;
    public static List<Long> RESOLVE_LAG_COUNT_TIME;
